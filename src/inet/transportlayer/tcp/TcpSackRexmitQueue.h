...
class INET_API TcpSackRexmitQueue
{
  ...
  public:
    ...
    virtual void skbSent(uint32_t seqNum, simtime_t m_firstSentTime, simtime_t m_lastSentTime, simtime_t m_deliveredTime, bool m_IsAppLimited, uint32_t m_delivered);
